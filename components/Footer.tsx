...
const Footer = () => {
  return (
    <footer className='bg-CustomDarkBlue text-CustomWhite text-center py-10 relative'>
      <div className='container mx-auto sm:px-4 sm:grid sm:grid-cols-[.5fr_.5fr_1fr] sm:justify-items-start'>
        <div className='sm:grid sm:grid-rows-2'>
          <div className='relative h-5 w-36 mx-auto'>
            <Image
          ...
          <ul
            className='py-4 grid grid-cols-[repeat(5,auto)]  gap-4 items-center justify-center sm:grid-cols-[repeat(5,1fr)] self-end'
            aria-label='Social links'
          >
            <li className='relative w-5 h-5 group'>
              <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20'>
                <path
                  fill='#FFF'
                  d='M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0z'
                  className='group-hover:fill-CustomLimeGreen'
                />
              </svg>
            </li>
            <li className='relative w-5 h-5 group'>
        ...
        <div>
          <ul className='grid grid-flow-row gap-4 gap-x-10 sm:text-left sm:grid-cols-2'>
            <li>
              <Link href='/'>
                <a className='hover:text-CustomLimeGreen'>About Us</a>
              </Link>
            </li>
            <li>
              <Link href='/'>
                <a className='hover:text-CustomLimeGreen'>Contact</a>
              </Link>
            </li>
            <li>
              <Link href='/'>
                <a className='hover:text-CustomLimeGreen'>Blog</a>
              </Link>
            </li>
            <li>
              <Link href='/'>
                <a className='hover:text-CustomLimeGreen'>Careers</a>
              </Link>
            </li>
            <li>
              <Link href='/'>
                <a className='hover:text-CustomLimeGreen'>Support</a>
              </Link>
            </li>
            <li>
              <Link href='/'>
                <a className='hover:text-CustomLimeGreen'>Privacy Policy</a>
              </Link>
            </li>
          </ul>
        </div>
